 ...
 */
@Deprecated
public class JsonCompareEntity1 {
    ...
    private static void analysisJson(Object beforeData, Object afterData,
        ...
        if (beforeObj instanceof JSONArray) {
            for (int i = 0; i < ((JSONArray) beforeObj).size(); i++) {
                ...
                Object objEntry = getTargetDataByLinkedList(beforeObject, beforeLinkedList, true, 0);//todo 获取到的可能是数组，也可能是实体
                //获取排序字段
                ...
                if (objEntry instanceof JSONArray || obj instanceof JSONArray){
                    ...
                    analysisJson(objEntry, obj, beforeLinkedList, afterLinkedList, newBefore, afterSort, relEntity, resultList, sort1);
                    if (objEntry instanceof JSONArray){
